...
// export const TOPLIST_URL = 'http://localhost:4000/top'
// export const SEARCH_URL = 'http://localhost:4000/search'
// export const LYRICS_URL = 'http://localhost:4000/lyrics'
  ...
  _createClass(Recommend, [{
    ...
    value: function renderRadios(radios) {
      this.$el.querySelector('.radios .list').innerHTML = radios.map(function (radio) {
        return '<div class="list-item">\n        <div class="list-media">\n          <img class="lazyload" src="../images/loading.gif" data-src="' + radio.picUrl + '">\n          <span class="icon icon-play"></span>\n        </div>\n        <div class="list-detail">\n          <h3 class="list-title">' + radio.Ftitle + '</h3>\n        </div>\n      </div>';
      }).join('');
    }
  }, {
    key: 'renderPlayLists',
    value: function renderPlayLists(playlists) {
      this.$el.querySelector('.playlists .list').innerHTML = playlists.map(function (list) {
        return '<div class="list-item">\n        <div class="list-media">\n          <img class="lazyload" src="../images/loading.gif" data-src="' + list.picUrl + '">\n          <span class="icon icon-play"></span>\n        </div>\n        <div class="list-detail">\n          <h3 class="list-title">' + list.songListDesc + '</h3>\n          <div class="list-text"></div>\n        </div>\n      </div>';
      }).join('');
    }
  }]);
